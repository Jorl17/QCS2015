 ...
 * 
 */
@WebServiceClient(name = "InsulinDoseCalculator", targetNamespace = "http://server", wsdlLocation = "file:///Users/jbsimoes/Documents/Universidade/MEI/1/2/QCS/Project/QCS2015/A1/Insulin_WebService/src/server/InsulinDoseCalculator.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:///Users/jbsimoes/Documents/Universidade/MEI/1/2/QCS/Project/QCS2015/A1/Insulin_WebService/src/server/InsulinDoseCalculator.wsdl");
     ...
     */
    @WebEndpoint(name = "InsulinDoseCalculator")
    public InsulinDoseCalculator getInsulinDoseCalculator() {
        return super.getPort(new QName("http://server", "InsulinDoseCalculator"), InsulinDoseCalculator.class);
    }
     ...
     */
    @WebEndpoint(name = "InsulinDoseCalculator")
    public InsulinDoseCalculator getInsulinDoseCalculator(WebServiceFeature... features) {
        return super.getPort(new QName("http://server", "InsulinDoseCalculator"), InsulinDoseCalculator.class, features);
    }
